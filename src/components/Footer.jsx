...
function Footer() {
  ...
  return (
    <footer className="bg-v-dark-blue py-8">
      <div
        aria-label="footer nav for mobile"
        className="lg:hidden w-11/12 container mx-auto"
      >
        <form className="flex justify-between items-center">
          <label className="w-[70%]  mr-2">
            <input
              type="text"
              placeholder="Updates in your inbox…"
              id="email"
              className="h-14 w-full rounded-full pl-6"
            />
          </label>
          <button className="w-[30%] h-14 py-2 px-4 text-white text-center font-medium bg-b-red rounded-full">
            Go
          </button>
        </form>

        <nav className="w-11/12 mx-auto flex justify-between items-start text-white py-10 px-6">
          <ul>
            <li className="mb-5">
              <a href="#home">Home</a>
            </li>
        ...
        <div className="w-11/12 md:w-1/2 mx-auto flex justify-between items-start px-6 pb-4">
        ...
        <img src={Logo} alt="Footer logo" className="my-10 mx-auto" />

        <p className="text-dark-grayish-blue text-base text-center">
          Copyright 2020. All Rights Reserved
        </p>
      </div>
      <div className="hidden lg:flex lg:justify-between lg:items-start lg:w-11/12 container mx-auto py-8">
        <div className="grid grid-rows-1 gap-28">
          ...
          <div className="w-full flex justify-between items-center">
            <svg
              ...
              height="20"
              fill="#FFF"
              className="hover:cursor-pointer hover:fill-current hover:text-b-red"
            >
        ...
        <div>
          <nav className="w-11/12 mx-auto flex justify-between items-start text-white">
            <ul className="w-full whitespace-nowrap">
              <li className="mb-5 hover:text-b-red">
                <a href="#home">Home</a>
              </li>
              <li className="mb-5 hover:text-b-red">
                <a href="#home">Pricing</a>
        ...
        <div>
          <nav className="w-full mx-auto flex justify-between items-start text-white">
            <ul className="w-full whitespace-nowrap">
              <li className="mb-5 hover:text-b-red">
                <a href="#home">Careers</a>
              </li>
        ...
        <div className="w-2/5 grid grid-rows-1 gap-20">
          <form className="flex justify-between items-start w-full">
            <label className="w-[70%]  mr-2">
              <input
                ...
                className={`w-full h-14  rounded-full pl-6 outline-none ${
                  isError
                    ? "border-2 border-solid border-red-600 text-red-600 placeholder-red-500"
                    : ""
                }`}
              />
              <span
            ...
            <button
              onClick={handleClick}
              className="w-[30%] h-14 py-2 px-4 text-white text-center font-medium bg-b-red rounded-full hover:bg-red-300"
            >
              Go
            </button>
          </form>

          <p className="text-dark-grayish-blue text-base text-right">
            Copyright 2020. All Rights Reserved
          </p>
        </div>
      </div>
